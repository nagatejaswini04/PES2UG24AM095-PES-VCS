...
```
PES_AUTHOR="Naga Tejaswini <PES2UG24AM095>"
```
...
GitHub Repository: https://github.com/nagatejaswini04/PES2UG24AM095-PES-VCS/tree/main
...
```bash
export PES_AUTHOR="Naga Tejaswini <PES2UG24AM095>" && ./pes [command]
```
